...
- [Проект "Обмен валют"](#проект-обмен-валют)
  - [Мотивация проекта](#мотивация-проекта)
  - [Использованные технологии и инструменты](#использованные-технологии-и-инструменты)
  - [База данных](#база-данных)
  - [REST API](#rest-api)
    - [Манипуляции с валютами](#манипуляции-с-валютами)
    - [Манипуляции с обменными курсами](#манипуляции-с-обменными-курсами)
    - [Обмен валюты](#обмен-валюты)
    - [Ответ в случае ошибки](#ответ-в-случае-ошибки)
  - [Фронтенд](#фронтенд)
